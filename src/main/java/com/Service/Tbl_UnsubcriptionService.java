...
//					try {
//					List<TblPlayer> player = playerRepo.findBypId(subId);
//					System.out.println("The value of player is"+player);
//					if(player.size()!=0) {
//					for (TblPlayer tblPlayer : player) {
//						System.out.println("The value of plyer is" + tblPlayer);
//						playerRepo.delete(tblPlayer);
//						System.out.println("Data Delete From tbl_Player");
//
//					}
//
//				}else {
//					unSubRequest.setStatus("0");
...
//					}
//					try {
//				List<TblFavourite> favourite = favouriteRepo.findById(subId);
//				if (favourite.size() != 0) {
//					for (TblFavourite tblFavourite : favourite) {
//
//						System.out.println("The value of fav is" + tblFavourite);
//						favouriteRepo.delete(tblFavourite);
//						System.out.println("Value delete from tbl_Favourite");
//					}
//					
//				}else {
//					unSubRequest.setStatus("0");
...
//					}
				...
				List<TblBillingLogs> billingLogs = logsRepo.findByAni(Long.parseLong(subscription.getAni()));
